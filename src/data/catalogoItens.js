...
export const catalogoItens = [
  ...
  { id: "pista-led-slim-paris-black", slug: "pista-led-slim-paris-black", nome: "Pista de LED Slim Paris Black", descricao: "Pista de LED para valorizar a experiência visual do evento.", categoria: "efeito", imagem: imagem("estruturas", "pista-led-slim-paris-black"), imagemFallback: PLACEHOLDER_ITEM_IMAGE, exibirImagemNoPdf: true, ativo: true, ordem: 4 },
