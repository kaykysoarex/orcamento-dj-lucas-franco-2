...
test("cadastra os 27 itens com IDs e imagens estáveis", () => {
  assert.equal(catalogoItens.length, 27);
  ...
  assert.equal(buscarItemPorId("controladora-denon-sc-live-4").categoria, "equipamento");
